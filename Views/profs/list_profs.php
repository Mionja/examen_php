...
<?php if ($_SESSION["status"] != 'etudiant') {?>    
    ...
    <div class="media text-muted pt-3">
          <img src="/mine/PHP/assets/uploaded_img/<?= $prof['photo']?>" class="mr-2 rounded mt-2" style="width: 45px; height: 45px;" >
        ...
        <?php  } ?>
                <div class="d-flex justify-content-between align-items-center w-100">
                    ...
                    <?php if ($_SESSION["status"] == 'admin') {?> 
                    <a href="/mine/PHP/index.php?page=Ctrl_profs&view=edit&id=<?= $prof['id']?>" title="Modifier information" class="mr-5 mt-3 text-success" ><img src="/mine/PHP/assets/img/modify.png" alt="img_modify" style="width:25px;"></a>
                    <?php  } ?>
                    </strong>
